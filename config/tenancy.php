...
// Using package as tenant DB
// created: thanhnt
// date: 27/04/2020
$sub_suffix = '/Database/Migrations';
$migrationDirs = [];
array_push($migrationDirs, database_path('migrations/tenant'));
$directories = glob(base_path('Modules') . '/*', GLOB_ONLYDIR);
foreach ($directories as $dir) {
    array_push($migrationDirs, $dir . $sub_suffix);
}
...
return [
    ...
    'db'         => [
         ...
         */
        'tenant-migrations-path'            => $migrationDirs,
         ...
         */
        'tenant-seed-class'                 => Modules\Core\Database\Seeders\TenantSeeder::class,
