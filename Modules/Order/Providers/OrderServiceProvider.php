...
use Modules\Order\Repositories\Cache\OrderCacheRepository;
use Modules\Order\Repositories\Cache\OrderItemCacheRepository;
...
{
    public $bindings = [
        OrderRepositoryInterface::class     => OrderCacheRepository::class,
        OrderItemRepositoryInterface::class => OrderItemCacheRepository::class,
    ];
    /**
